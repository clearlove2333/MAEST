...
def main(args):
    ...
    for i, seed in enumerate(seeds):
        ...
        #初始化模型
        function = Function(datatype=dataset, n_clusters=14)
        import scanpy as sc
        adata = sc.read_visium('/zhupengfei/STExperiment/Data/mouse_brain_s1_s2/s2/posterior', count_file='filtered_feature_bc_matrix.h5', load_images=True)
        # adata = sc.read_visium('/zhupengfei/STExperiment/Data/mouse_brain_s1_s2/s1/posterior/', count_file='filtered_feature_bc_matrix.h5', load_images=True)
